package com.maxlong.study.collections;
...
public class TreeMap<K,V> extends AbstractMap<K,V> implements NavigableMap<K,V>, Cloneable, java.io.Serializable {
    ...
    public transient TreeMap.Entry<K,V> root;
    ...
    final class EntryIterator extends PrivateEntryIterator<TreeMap.Entry<K,V>> {
     ...
     * @serial include
     */
    public abstract static class NavigableSubMap<K,V> extends AbstractMap<K,V>
    ...
    public static final class Entry<K,V> implements Map.Entry<K,V> {
        K key;
        V value;
        public TreeMap.Entry<K,V> left;
        public TreeMap.Entry<K,V> right;
        public TreeMap.Entry<K,V> parent;
        boolean color = BLACK;
     ...
     */
    public final TreeMap.Entry<K,V> getFirstEntry() {
        TreeMap.Entry<K,V> p = root;
        if (p != null)
            while (p.left != null)
                p = p.left;
